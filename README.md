...
- Canonical embedded-enchant appraisal policy with frozen acquisition weights, Level I–X multipliers, exact book values, 70% aggregate contribution without Market-price input, and an identity-aware `CanonicalEnchant`→appraisal-class/value bridge that prevents caller-supplied class drift.
