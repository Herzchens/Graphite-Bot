...
| 6 | Repair / Forge / Smelt / Enchant / +N / SoulBind | Smelting policy/preview, persistent per-job reservation ownership, immutable tickless runtime snapshots, and pure freeze-aware terminal consequence planning implemented; authoritative Hard Freeze overlap tracking, production resource definitions/bridge, atomic terminal Smelting settlement, live Confirm/commands, and remaining service systems are pending |
| 7 | Fishing | Pending |
