use graphite_services::{
    FishingRarity, MANUAL_FISHING_JUNK_AEXP, MANUAL_FISHING_MULTI_TREASURE_AEXP_CAP,
...
#[test]
fn public_api_matches_every_frozen_single_result_aexp_value() {
    assert_eq!(MANUAL_FISHING_JUNK_AEXP, 2);
    assert_eq!(MANUAL_FISHING_TREASURE_AEXP, 5);
    assert_eq!(MANUAL_FISHING_MULTI_TREASURE_AEXP_CAP, 10);
...
#[test]
fn public_api_creates_no_aexp_grant_for_failed_fish_outcomes() {
    assert_eq!(
...
#[test]
fn public_api_caps_multi_treasure_and_rejects_noncanonical_counts() {
