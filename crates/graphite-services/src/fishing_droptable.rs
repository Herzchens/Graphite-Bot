...
///
/// The latest canonical within-Treasure chances 38% / 26% / 10% / 8% / 10% / 8% are represented
/// as the reduced common-scale relative weights 19 / 13 / 5 / 4 / 5 / 4. Treasure-branch modifiers
